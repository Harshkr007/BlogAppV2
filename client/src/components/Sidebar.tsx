  ...
  return (
    <div className="flex flex-col h-full bg-slate-200">
      <div className="flex-grow">
        ...
        <div
          className={`flex w-full p-2 text-2xl font-bold hover:bg-slate-300 cursor-pointer ${
            currPath === "/userBlog" || currPath.includes("/editBlog/")
              ? "bg-slate-300"
              : ""
          }`}
      ...
      <div
        className={`flex items-center justify-between w-full p-4 border-t-2 border-slate-300 hover:bg-slate-300 cursor-pointer ${
      ...
      >
        ...
        <div
          className="p-2 hover:bg-slate-400 rounded-full cursor-pointer transition-colors"
          onClick={(e) => {
            e.stopPropagation();
            handleUserLogout();
          }}
